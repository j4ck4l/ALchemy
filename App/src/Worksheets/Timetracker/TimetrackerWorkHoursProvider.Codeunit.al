...
//         CannotParseResponseErr: Label 'Error parsing response from Timetracker';
//         PathTok: Label 'workhours/%1/%2/%3', Locked = true;
//     begin
//         Year := Date2DMY(AtDate, 3);
//         Month := Date2DMY(AtDate, 2);
//         Employee.TestField(TimetrackerEmployeeId);
//         Request := TimetrackerSetup.CreateRequest(StrSubstNo(PathTok, Employee.TimetrackerEmployeeId, Year, Month));
...
//         CannotParseResponseErr: Label 'Error parsing response from Timetracker';
//         PathTok: Label 'status/%1', Locked = true;
//     begin
//         Request := TimetrackerSetup.CreateRequest(StrSubstNo(PathTok, Ticket));
//         Client.Send(Request, Response);
//         if not Response.IsSuccessStatusCode then
...
//         CannotParseResponseErr: Label 'Error parsing response from Timetracker';
//         PathTok: Label 'results/%1', Locked = true;
//     begin
//         Request := TimetrackerSetup.CreateRequest(StrSubstNo(PathTok, Ticket));
//         Client.Send(Request, Response);
//         if not Response.IsSuccessStatusCode then
